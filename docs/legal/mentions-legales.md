...
- Siège social : [ADRESSE_SIEGE], Ouagadougou, Burkina Faso
- RCCM : [RCCM]
- IFU : [IFU]
- Téléphone : [TELEPHONE]
...
Le directeur de la publication est **Lassané NACOULMA**, en sa qualité de propriétaire de L'N EXPERTISE.
...
Le traitement des données à caractère personnel collectées via la plateforme est réalisé conformément à la législation en vigueur au Burkina Faso, notamment :

- La loi n°010-2004/AN du 20 avril 2004 portant protection des données à caractère personnel au Burkina Faso ;
- Les lignes directrices de la **CNDP** (Commission Nationale de l'Informatique et des Libertés — Burkina Faso).

Pour toute question relative à vos données personnelles, contactez notre Délégué à la Protection des Données (DPD) : [EMAIL_DPO]
...
L'N EXPERTISE s'efforce de maintenir la plateforme accessible et à jour. Toutefois, elle ne saurait être tenue responsable des dommages directs ou indirects résultant de l'utilisation de la plateforme, d'interruptions de service ou d'erreurs dans les informations présentées.

---

## 8. Droit applicable

Les présentes mentions légales sont soumises au droit burkinabè et aux dispositions applicables de l'**OHADA** (Organisation pour l'Harmonisation en Afrique du Droit des Affaires).

Tout litige relatif à l'interprétation ou à l'exécution des présentes sera soumis aux tribunaux compétents d'Ouagadougou, Burkina Faso.
